...
Do not manually disable `com.amazon.ftvads.deeplinking`: this exact NS6711 build
marks it protected, and the controller requires it to remain enabled through
the core-preservation guard.
